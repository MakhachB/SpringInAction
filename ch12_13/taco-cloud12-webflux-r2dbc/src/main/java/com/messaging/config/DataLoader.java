...
public class DataLoader {
    ...
    public CommandLineRunner RepoDataLoader(
        ...
        return args -> {
            ...
            taco1.setIngredientIds(Set.of(
                    flourTortilla.getId(), groundBeef.getId(), carnitas.getId(),
                    sourCream.getId(), salsa.getId(), cheddar.getId()));
            tacoRepo.save(taco1).subscribe();

            Taco taco2 = new Taco();
            taco2.setName("Bovine Bounty");
            taco2.setIngredientIds(Set.of(
                    cornTortilla.getId(), groundBeef.getId(), cheddar.getId(),
                    jack.getId(), sourCream.getId()));
            tacoRepo.save(taco2).subscribe();

            Taco taco3 = new Taco();
            taco3.setName("Veg-Out");
            taco3.setIngredientIds(Set.of(
                    flourTortilla.getId(), cornTortilla.getId(), tomatoes.getId(),
                    lettuce.getId(), salsa.getId()));
